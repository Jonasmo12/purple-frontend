import { BrowserRouter, Routes, Router, Link, Route, useNavigate } from 'react-router-dom';
import './App.css';
            ...
            <div>
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        <Link class="navbar-brand" to="/patient">Purple</Link>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <Link className="nav-link active" aria-current="page" to='/account'>
                                    ...
                                    <span className='' style={{paddingLeft: '10px'}}>Account</span>
                                </Link>
                            </li>
                        </ul>
                        <div class="d-flex">
